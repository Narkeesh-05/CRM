...
class _MyFormState extends State<MyForm> {
  ...
  Future<void> saveFormData(FormData formData) async {
    ...
    formDataListJson.add(jsonEncode(formData.toJson()));
    prefs.setStringList('formDataList', formDataListJson);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Client Form', style: TextStyle(color: Colors.white)),
        centerTitle: true,
        actions: [
          IconButton(
